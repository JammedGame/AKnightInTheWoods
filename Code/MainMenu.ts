...
class MainMenu extends TBX.Scene2D
{
    ...
    public Init() : void
    {
        ...
        Play.Index = 0;
        Play.Paint = TBX.Color.Aqua;
        Play.Trans.Scale = new TBX.Vertex(175, 100, 1);
        Play.Trans.Translation = new TBX.Vertex(1500, 600, 3);
        Play.Material.Sampling = TBX.TextureSamplingType.Linear;
        Play.Events.MouseDown.push(this.PlayClick.bind(this));
        let Titles:TBX.ImageCollection = new TBX.ImageCollection(null, ["/Resources/Textures/Title.png"]);
        let Title:TBX.Tile = new TBX.Tile();
        Title.Name = "Title";
        Title.Collection = Titles;
        Title.Index = 0;
        Title.Trans.Scale = new TBX.Vertex(1800, 300, 1);
        Title.Trans.Translation = new TBX.Vertex(960, 220, 1);
        this.Attach(Title);
        this.LoadSets();
        this.Attach(Play);
