...
class MainMenu extends Engineer.Scene2D
{
    ...
    private LoadSets(): void 
    {
        ...
        for (let i = 0; i < 4; i++) SpriteSetSkin0.Sprites.push("Resources/Textures/FireFrame" + i + ".png");
        ...
        for (let i = 0; i < 1; i++) SpriteSetSkin1.Sprites.push("Resources/Textures/log" + i + ".png");
